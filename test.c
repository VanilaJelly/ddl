...
/*
    ...
    fuzzy_hash_file(fp, res);

    printf ("%s\n", res);

    str1 = "3:G6TSrQRdWv1Ssh:G6eUASo";
    str2= "3:G6TSsiUsVUdV:G6e9PVEVi";

    str3 = "3:2BEq7FdnPRn:2BjJdnZn";
    str4 = "3:KGD3q7FdnPRn:KGD6JdnZn";

    result = fuzzy_compare(str2, str2);
    printf ("%d\n", result);

    result = fuzzy_compare(str1, str2);
    printf ("%d\n", result);

    result = fuzzy_compare(str3, str4);
    printf ("%d\n", result);
